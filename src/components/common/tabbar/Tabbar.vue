<template>
  <div id="tabbar">
     <!--<slot></slot>-->
    <TabBarItem path="/home" active-color="skyblue">
    ...
    <TabBarItem path="/category" active-color="skyblue">
      <template v-slot:slot-img>
    ...
    <TabBarItem path="/cart" active-color="skyblue">
      <template v-slot:slot-img>
    ...
    <TabBarItem path="/profile" active-color="skyblue">
      <template v-slot:slot-img>
